...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-screen text-white px-6 md:px-20 py-20 overflow-hidden flex flex-col md:flex-row items-center justify-between"
    >
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold drop-shadow-[0_0_25px_cyan] leading-relaxed min-h-[200px] md:min-h-[180px] flex items-center">
          <Typewriter
            key={loopIndex}
            options={{
